...
class FifteenMinActivity : AppCompatActivity() {

    private var firstCounter: Int = 900
    private var secondCounter: Int = 900
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        firstPlayerTextCounter.setText(R.string.fifteen_min_timer)
        ...
        secondPlayerTextCounter.setText(R.string.fifteen_min_timer)
