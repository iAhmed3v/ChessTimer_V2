...
class ThirtyMinActivity : AppCompatActivity() {

    private var firstCounter: Int = 1800
    private var secondCounter: Int = 1800
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        firstPlayerTextCounter.setText(R.string.thirty_min_timer)
        ...
        secondPlayerTextCounter.setText(R.string.thirty_min_timer)
