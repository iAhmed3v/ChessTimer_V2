...
class TwentyMinActivity : AppCompatActivity() {

    private var firstCounter: Int = 1200
    private var secondCounter: Int = 1200
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        firstPlayerTextCounter.setText(R.string.twenty_min_timer)
        ...
        secondPlayerTextCounter.setText(R.string.twenty_min_timer)
